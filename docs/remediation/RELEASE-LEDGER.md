...
Status: producer deployed and verified, including a real scheduled publication; consumer preview review in progress. Scope and staged sequence: [PERIOD-FEEDS.md](PERIOD-FEEDS.md).
