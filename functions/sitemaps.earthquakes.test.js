...
describe('Paginated Earthquake Sitemaps Handler (D1)', () => {
    ...
    it('/sitemaps/earthquakes-1.xml should return XML with only events having advanced data', async () => {
        const now = Date.now();
        ...
        const mockDbResults = {
            results: [
                ...
                // 2. Has shakemap
                {
                    id: "ev_with_shakemap", magnitude: 4.4, place: "Shakey Town",
    ...
    it('/sitemaps/earthquakes-1.xml should only include events with advanced data (shakemap, moment-tensor, focal-mechanism)', async () => {
        ...
        const mockDbResults = {
            results: [
                // 1. Event with shakemap
                {
                    id: "ev_with_shakemap", magnitude: 4.8, place: "Shakey Town",
