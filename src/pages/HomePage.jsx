                    ...
                    */}
                    ...
                    <footer className="p-1.5 text-center border-t border-slate-700 mt-auto">
                        <p className="text-[10px] text-slate-500">
                            &copy; {new Date().getFullYear()} <a href="https://builtbyvibes.com" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300">Built By Vibes</a> | Data: USGS
                        </p>
                    </footer>
                </aside>
