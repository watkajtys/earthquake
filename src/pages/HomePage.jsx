...
const WhatCausesEarthquakesPage = lazy(() => import('./learn/WhatCausesEarthquakesPage'));
const EarthquakeSafetyPage = lazy(() => import('./learn/EarthquakeSafetyPage'));
const TsunamisPage = lazy(() => import('./learn/TsunamisPage'));
                    ...
                    <ErrorBoundary>
                        <Suspense fallback={<RouteLoadingFallback />}>
                            <Routes>
                              ...
                              <Route path="/learn/what-causes-earthquakes" element={<WhatCausesEarthquakesPage />} />
                              <Route path="/learn/earthquake-safety" element={<EarthquakeSafetyPage />} />
                              <Route path="/learn/tsunamis-and-earthquakes" element={<TsunamisPage />} />
                ...
                <aside className="hidden lg:flex w-[480px] bg-slate-800 p-0 flex-col border-l border-slate-700 shadow-2xl z-20">
                    ...
                    */}
                    ...
                    <footer className="p-1.5 text-center border-t border-slate-700 mt-auto">
                        <p className="text-[10px] text-slate-500">&copy; {new Date().getFullYear()} <a href="https://www.builtbyvibes.com" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300">Built By Vibes</a> | Data: USGS</p>
                    </footer>
                </aside>
