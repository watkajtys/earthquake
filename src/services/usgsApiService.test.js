...
// All tests commented out as the fetchUsgsData function in usgsApiService.js is no longer used by the client.
// Client now fetches data via Cloudflare Worker.
describe('USGS API Service Tests', () => {
  it.todo('Tests removed as client-side USGS direct fetch is no longer used.');
});
