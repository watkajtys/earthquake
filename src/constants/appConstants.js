...
/** @description Minimum magnitude for an earthquake to be considered a 'microquake' for display purposes in sequence charts. */
export const MICROQUAKE_THRESHOLD = 2.5;
