...
export const getMagnitudeColor = (magnitude) => {
    ...
    if (magnitude < 8.0) return '#E879F9'; // fuchsia-400 (Magnitude 7.0-7.9)
    return '#6B21A8'; // purple-800 (Magnitude 8.0+)
};
...
export const getMagnitudeColorStyle = (magnitude) => {
    ...
    if (magnitude < 8.0) return 'bg-fuchsia-400 text-white';       // Magnitude 7.0-7.9
    return 'bg-purple-800 text-white';                            // Magnitude 8.0+
};
