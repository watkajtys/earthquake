            ...
            >
                ...
                <div style={{ height: '200px', width: '100%' }} className="my-4">
                    {sortedQuakes.length > 0 ? (
                        <EarthquakeMap
                            earthquakesToPlot={sortedQuakes}
                            // Zoom is handled by EarthquakeMap's fitBounds or its own default
                        />
                    ) : (
                        <EarthquakeMap
                            earthquakesToPlot={[]}
                            ...
                            nearbyQuakes={[]} // Pass empty for fallback mode
                            // Zoom will use EarthquakeMap's default (e.g. 8 or what it defines)
                        />
                    )}
                </div>
